...
![descript](./目标检测/media/image1.png)

评价指标

Confusion Matrix（混淆矩阵）

![descript](./目标检测/media/image2.png)
...
$$
Accuracy = \frac {所有正确预测的样本数量} {总样本数量} = \frac {TP + TN} {TP + FP + FN + TN}
$$
...
$$
Precision = \frac {预测为正例的样本中正确的数量} {预测为正类的样本数量} = \frac {TP} {TP + FP}
$$
...
$$
Recall = \frac {预测为正例的样本中正确的数量} {正例的样本数量} = \frac {TP} {TP + FN}
$$
...
![descript](./目标检测/media/image7.png)

2019年综述论文：《Object Detection in 20 Years: A Survey》

![descript](./目标检测/media/image8.jpg)
![descript](./目标检测/media/image9.jpg)
